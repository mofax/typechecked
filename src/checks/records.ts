...
export function isRecord
    <T extends CheckArgRecord>
    (validations: T, options: CheckObjectOptions = {}) {
    ...
    return function (obj: unknown): CheckObjectReturn<typeof validations> {
        ...
        for (let entry of Object.entries(validations)) {
...
export function isPartialRecord<T extends CheckArgRecord>(validations: T, options: CheckObjectOptions) {
